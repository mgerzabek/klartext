...
Gem::Specification.new do |spec|
  ...
  spec.files = `git ls-files -z`.split("\x0").select { |f| f.match(%r!^(_data|_includes|_layouts|_sass|assets|_config\.yml|LICENSE|README)((\.(css|html|js|json|md|scss|svg|txt|yml)|$)))!i) }
